...
exports.streamFile = function (filepath, stat, res) {
  ...
  fs.open(filepath, process.O_RDONLY, 0666)
...
exports.deliver = function (webroot, req, res) {
  ...
  fileStat.addCallback(function (stat) {
    ...
    if (!stat.isFile()) {
      ...
      if (cancel) {
        ...
        fileStream = exports.streamFile(filepath, stat, res);
        if (afterCallback) {
          fileStream.addCallback(afterCallback);
        }
        if (errorCallback) {
          fileStream.addErrback(errorCallback);
        }
      }
    }
  });
  ...
  if (otherwiseCallback) {
    fileStat.addErrback(otherwiseCallback);
  }
