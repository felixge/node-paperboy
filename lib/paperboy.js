...
exports.fabware = function (webroot) {
  ...
  return function (handler) {
    return function (respond) {
      //I don't use fabware, so I don't know if the security fixes to exports.filepath
      //broke this
      var
        self = this,
...
exports.streamFile = function (filepath, stat, res, req, emitter) {
  var
    encoding = "binary",
...
exports.deliver = function (webroot, req, res, callbacks) {
  var
    stream,
    ...
    fs.stat(filepath, function (err, stat) {
      if( (err || !stat.isFile()) && callbacks.otherwise) {
        ...
        if (cancel && callbacks.otherwise) {
          ...
          stream = exports.streamFile(filepath, stat, res, req, sEmitter);
        }
      }
    });
  }
